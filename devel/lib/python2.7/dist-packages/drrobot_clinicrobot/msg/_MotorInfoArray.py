"""autogenerated by genpy from drrobot_clinicrobot/MotorInfoArray.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import drrobot_clinicrobot.msg
import std_msgs.msg
...
"""
  ...
  _slot_types = ['drrobot_clinicrobot/MotorInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = drrobot_clinicrobot.msg.MotorInfo()
        _v3 = val1.header
        start = end
        end += 4
